...
(() => {
  'use strict';
  const defaults = {density:110,size:130,brilliance:135,softness:65,depth:100,speed:115,trails:35,haze:85,roundness:100,...window.PortfolioVisualDefaults?.settings?.atmosphere?.sparks};
  const controls = [
